              ...
              <div className="flex flex-col items-center justify-start w-full gap-3">
                <div className="flex flex-row justify-start w-full gap-5">
                  <Input
                    ...
                    className="w-[29%] gap-[35px] !text-gray-700 border-blue_gray-100_01 border border-solid"
                  />
                  <SelectBox
                  ...
                  <SelectBox
                    indicator={<Img src="images/img_vector_gray_700_10x17.svg" alt="Vector" />}
                    name="pressed"
                    placeholder="Quartos - 3"
                    options={dropDownOptions}
                    className="w-[14%] gap-px font-bold border-blue_gray-100_01 border border-solid"
                  />
                  <Button
                    color="white_A700"
                    size="4xl"
                    rightIcon={<Img src="images/img_vector_gray_700_2x19.svg" alt="Vector" />}
                    className="gap-[15px] !text-gray-700 font-bold border-blue_gray-100_01 border border-solid min-w-[109px]"
                  >
                    Mais
                  </Button>
                  <Button
            ...
            <div className="flex flex-col items-center justify-start w-full max-w-[1200px]">
              <div className="flex flex-row justify-between items-start w-full">
                <Img
                  ...
                  alt="map_one"
                  className="w-[14px] mt-[496px] object-cover rounded-[50%]"
                />
                <div className="flex flex-row justify-center items-start w-[78%]">
                  <div className="flex flex-col items-end justify-start w-[10%] gap-[660px]">
                    <Img src="images/img_group_1000001533.svg" alt="image" className="h-[12px] w-[11px]" />
                    <div className="flex flex-col items-start justify-start w-[96%] mr-1 gap-3.5">
                      <div className="flex flex-row justify-start items-center gap-[9px]">
                        <RatingBar
                          ...
                          className="flex justify-between h-[16px] w-[16px]"
                        />
                        <Heading size="xs" as="h2" className="!text-gray-700 !text-[12.83px]">
                          1 Banheiro
                        </Heading>
                      </div>
                      <div className="flex flex-row justify-start items-center gap-[9px]">
                  ...
                  <div className="h-[972px] w-[2%] mt-1 ml-3 border-gray-600_02 border border-solid bg-white-A700 rounded-[5px]" />
                  <div className="flex flex-col items-center justify-start w-[1%] mt-[744px] ml-1 z-[1]">
                    <Heading size="xl" as="h4" className="tracking-[-0.38px] !text-[19.25px]">
                      $649,900
                    </Heading>
                  </div>
                  <div className="flex flex-col items-start justify-start w-[3%] mt-[330px] ml-[-1px]">
                    ...
                    <RatingBar
                      ...
                      size={16}
                      starCount={1}
                      className="flex justify-between h-[16px] w-[16px] mt-[324px]"
                    />
                    <RatingBar
                      value={1}
                      isEditable={true}
                      ...
                      size={16}
                      starCount={1}
                      className="flex justify-between h-[16px] w-[16px] mt-4"
                    />
                  </div>
                  <div className="flex flex-col items-center justify-start w-[85%] gap-[60px]">
                    <div className="flex flex-col items-center justify-start w-full">
                      <div className="flex flex-col w-full gap-6">
                        <div className="h-[1048px] w-full relative">
                          <Heading
                            size="xs"
                            as="h5"
                            className="w-[1%] left-[1%] top-[3%] m-auto !text-[12.83px] !leading-[23px] absolute"
                          >
                          ...
                          <div className="flex flex-col items-center justify-center w-full h-full left-0 bottom-0 right-0 top-0 m-auto absolute">
                            <div className="justify-center w-full gap-6 grid-cols-2 grid">
                              <div className="flex flex-col items-center justify-start w-full">
                                <Img
                                ...
                                <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                                  ...
                                  <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                    ...
                                    <div className="flex flex-row justify-between items-center w-full">
                                      ...
                                      <div className="flex flex-row justify-start items-center gap-3">
                                        <Img
                                          src="images/img_iocn_menu_5.svg"
                                          alt="familia_one"
                                          className="h-[20px] w-[20px]"
                                        />
                                        <a href="#">
                              ...
                              <div className="flex flex-col items-center justify-start w-full">
                                ...
                                <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                                  ...
                                  <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                    ...
                                    <div className="flex flex-row justify-between items-center w-full pr-[67px]">
                                      <div className="flex flex-row justify-start items-center gap-3">
                                        <Img
                                          src="images/img_icon_gray_700_20x20.svg"
                                          alt="1032_sqft_one"
                                      ...
                                      <div className="flex flex-row justify-start items-center gap-3">
                                        <Img
                                          src="images/img_iocn_menu_6.svg"
                                          alt="familia_one"
                                          className="h-[20px] w-[20px]"
                                        />
                                        <a href="#">
                              ...
                              <div className="flex flex-col items-center justify-start w-full">
                                <div className="flex flex-col items-center justify-start w-full">
                                  <div className="h-[260px] w-full relative">
                                    ...
                                    />
                                    <div className="flex flex-col items-center justify-start w-[16%] gap-4 bottom-[27%] left-[2%] m-auto absolute">
                                      <Heading size="xs" as="p" className="!text-gray-700 !text-[12.83px]">
                                        3 Quartos
                                      </Heading>
                                      <Heading size="xs" as="p" className="!text-gray-700 !text-[12.83px]">
                                        1,032 sqft
                                  ...
                                  <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                                    ...
                                    <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                      ...
                                      <div className="flex flex-row justify-between items-center w-full">
                                        ...
                                        <div className="flex flex-row justify-start items-center gap-3">
                                          <Img
                                            src="images/img_iocn_menu_7.svg"
                                            alt="familia_one"
                                            className="h-[20px] w-[20px]"
                                          />
                                          <a href="#">
                                ...
                                <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                                  ...
                                  <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                    ...
                                    <div className="flex flex-row justify-between items-center w-full">
                                      ...
                                      <div className="flex flex-row justify-start items-center gap-3">
                                        <Img
                                          src="images/img_iocn_menu_8.svg"
                                          alt="familia_one"
                                          className="h-[20px] w-[20px]"
                                        />
                                        <a href="#">
                            ...
                            <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                              ...
                              <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                ...
                                <div className="flex flex-row justify-between items-center w-full">
                                  ...
                                  <div className="flex flex-row justify-start items-center gap-3">
                                    <Img
                                      src="images/img_iocn_menu_9.svg"
                                      alt="família_one"
                                      className="h-[20px] w-[20px]"
                                    />
                                    <a href="#">
                            ...
                            <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                              ...
                              <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                ...
                                <div className="flex flex-row justify-between items-center w-full pr-[67px]">
                                  ...
                                  <div className="flex flex-row justify-start items-center gap-3">
                                    <Img
                                      src="images/img_iocn_menu_10.svg"
                                      alt="iocnmenu_one"
                                      className="h-[20px] w-[20px]"
                                    />
                                    <a href="#">
                            ...
                            <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                              ...
                              <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                ...
                                <div className="flex flex-row justify-between items-center w-full">
                                  ...
                                  <div className="flex flex-row justify-start items-center gap-3">
                                    <Img
                                      src="images/img_iocn_menu_11.svg"
                                      alt="iocnmenu_one"
                                      className="h-[20px] w-[20px]"
                                    />
                                    <a href="#">
                            ...
                            <div className="flex flex-col items-center justify-center w-full gap-[25px] p-5 rounded-bl-[10px] rounded-br-[10px] border-red-100_01 border border-solid bg-white-A700">
                              ...
                              <div className="flex flex-col items-center justify-start w-full gap-[18px]">
                                ...
                                <div className="flex flex-row justify-between items-center w-full">
                                  ...
                                  <div className="flex flex-row justify-start items-center gap-3">
                                    <Img
                                      src="images/img_iocn_menu_12.svg"
                                      alt="iocnmenu_one"
                                      className="h-[20px] w-[20px]"
                                    />
                                    <a href="#">
